...
I:(1) Try this:
*:_Q_R_L3
D:ciea nsth ciea nsth ciea nsth ciea nsth ciea nsth ciea nsth

I:Now this (use 'k' finger for 'i' and 'd' finger for 'e'):
*:_Q_R_L4
D:cieoa nstdh cieoa nstdh cieoa nstdh cieoa nstdh cieoa nstdh

I:(2) Some more:
*:_Q_R_L5
D:ci cs ce ct ca ch ac tc ec sc ic hc is ie it ia si ei ti ai
 :ee se ce te ie he ae ee es ec et ei eh ea ee sa et es as ts
 :ti ci si ii ei hi ai ic is ii it ie ih ia ee ee ii aa ss ei

I:(1) Rhythm Drill
*:_Q_R_L6
D:cnisetah,. cnisetah,. cnisetah,. cnisetah,. cnisetah,.
 :jdowc,.t swtdhsh.h/ jdowc,.t swtdhsh.h/ jdowc,.t
 :s.  c.  s.  s.  s.  d.  s.  e.  s.  n.  s.  t.  s.  o.
...
*:_Q_R_L14
D:ci wi oi li di c/ w/ o/ l/ d/ c' w' o' l' d' ce we oe le de
 :ic iw io il id /c /w /o /l /d 'c 'w 'o 'l 'd .c .w .o .l .d
 :ec ew eo el ed cl i' wd i. wd 'i .' wo /t wl /e lo /i ld '.
